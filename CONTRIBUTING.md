# Contributing to emi-ontology-linkml

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
emi-ontology-linkml. These guidelines are not strict rules.
...
The emi-ontology-linkml team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the emi-ontology-linkml technical leads
...
[issues]: https://github.com/earth-metabolome-initiative/emi-ontology-linkml/issues/
[pulls]: https://github.com/earth-metabolome-initiative/emi-ontology-linkml/pulls/
